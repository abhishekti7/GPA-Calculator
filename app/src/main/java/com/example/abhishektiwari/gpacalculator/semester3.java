...
public class semester3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gpa_calc = (Button)findViewById(R.id.calc_gpa3);
        ...
        gpa_calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag!=8){
                    Toasty.error(semester3.this,"Please enter grades for all subjects.",Toast.LENGTH_SHORT).show();
                }else{
                    calculateGPA();
                }
    ...
    public void calculateGPA(){
        ...
        double gpa = value1*2+
                ...
                value8*4;
        gpa = gpa/22;
        Toasty.normal(semester3.this,"Success",Toast.LENGTH_SHORT,ContextCompat.getDrawable(semester3.this,R.drawable.cloud)).show();
