...
public class semester4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gpa_calc = (Button)findViewById(R.id.calc_gpa4);
        ...
        gpa_calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag!=8){
                    Toasty.error(semester4.this,"Please enter grades for all subjects.",Toast.LENGTH_SHORT).show();
                }else{
                    calculateGPA();
                }
    ...
    public void calculateGPA(){
        ...
        DatabaseReference grade = myRef.child("userGrades").child("sem4");
        grade.setValue(gpa);
