...
public class semester5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gpa_calc = (Button)findViewById(R.id.calc_gpa5);
        ...
        gpa_calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag!=9){
                    Toasty.error(semester5.this,"Please enter grades for all subjects.",Toast.LENGTH_SHORT).show();
                }else{
                    calculateGPA();
                }
    ...
    public void calculateGPA(){
        ...
        double gpa = value1*3+ value2*3+ value3*3+ value4*3+ value5*3+ value6*3+ value7*2+ value8*2+ value9*2;
        gpa = gpa/24;
        ...
        DatabaseReference grade = myRef.child("userGrades").child("sem5");
        grade.setValue(gpa);
