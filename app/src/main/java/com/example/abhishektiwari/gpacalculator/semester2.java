...
public class semester2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gpa_calc = (Button)findViewById(R.id.calc_gpa2);
        ...
        gpa_calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag!=9){
                    Toasty.error(semester2.this,"Please enter grades for all subjects.",Toast.LENGTH_SHORT).show();
                }else{
                    calculateGPA();
                }
    ...
    public void calculateGPA(){
        ...
        DatabaseReference grade = myRef.child("userGrades").child("sem2");
        grade.setValue(gpa);
